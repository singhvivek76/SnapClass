...
def teacher_screen_login():
    ...
    with btnc2:
        if st.button('Register Instead', key='teacher_switch_to_register', type='primary', icon=':material/passkey:', width='stretch'):
...
def teacher_screen_register():
    ...
    with btnc2:
        if st.button('Login Instead', key='teacher_switch_to_login', type='primary', icon=':material/passkey:', width='stretch'):
            st.session_state.teacher_login_type = 'login'
            st.rerun()
